...
#define CONTROL_PANEL_WIDGET(obj)          GTK_CHECK_CAST (obj, control_panel_widget_get_type (), ControlPanelWidget)
#define CONTROL_PANEL_WIDGET_CLASS(klass)  GTK_CHECK_CLASS_CAST (klass, control_panel_widget_get_type (), ControlPanelWidgetClass)
#define IS_CONTROL_PANEL_WIDGET(obj)       GTK_CHECK_TYPE (obj, control_panel_widget_get_type ())

#if 0
typedef struct _ControlPanelWidget	ControlPanelWidget;
typedef struct _ControlPanelWidgetClass	ControlPanelWidgetClass;
...
#endif
error_t		control_panel_widget_init	(char *app_id,
						 struct argp *app_parser,
						 int argc,
						 char **argv,
						 unsigned int flags,
